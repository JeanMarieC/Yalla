    ...
    >
      {event && (
        <div className="flex h-full flex-col p-6 md:p-8">
          ...
          <p className="mt-1 text-sm text-zinc-500">{event.tags.join(" · ")}</p>

          <p className="mt-5 text-sm font-medium tabular-nums text-zinc-700">
          ...
          <div className="mt-6 rounded-2xl bg-zinc-50 p-5">
            ...
            <p className="mt-2 leading-relaxed text-zinc-700">{event.whyItFits}</p>
          </div>
